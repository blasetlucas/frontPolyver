/* Night is the baseline. Only a manual choice made by this control can enable day; legacy prototype preferences are ignored. */
(() => {
  const key = 'polyver-appearance-manual-v1';
